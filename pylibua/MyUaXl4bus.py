...
class MyUaXl4bus(UaXl4bus):
    ...
    def do_pre_install_A(self, downloadFileStr):
    ...
    def do_install_A(self, downloadFileStr):
...
if __name__ == "__main__":
    ...
    my_ua = MyUaXl4bus(cert_label='tbox-ua', cert_dir='/data/sota/pki/certs/tbox-ua',
                       conf_file='/data/sota/ua/ua.conf', ua_nodeType='/TBOX/7905030-DD02',
                       host_port=host_p)
